...
<div class="container">
   ...
   <%--  <center><c:out value="${nohistory}"/>
    ...
    <a href="<%=request.getContextPath() %>/data">dataview</a>
    <br>
    <a href="<%=request.getContextPath() %>/pdfgeneration">pdfgeneration</a>
    <br>
    <a href="<%=request.getContextPath() %>/pdfdata">pdfdata</a>
    <br>
    <a href="<%=request.getContextPath() %>/Addressview">pdfdata</a>
</div>
<!-- /container -->
 </body>
</html>
